...
#ifndef VISUALIZATION_CONCRETE_SIMPLEMCNP2_INCLUDED
#define VISUALIZATION_CONCRETE_SIMPLEMCNP2_INCLUDED
...
class SimpleMCNP2:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	SimpleMCNP2(void); // Default constructor
