/***********************************************************************
Reservoir - Example class demonstrating how to write new modules for
...
#ifndef VISUALIZATION_CONCRETE_RESERVOIR_INCLUDED
#define VISUALIZATION_CONCRETE_RESERVOIR_INCLUDED
...
class Reservoir:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	Reservoir(void); // Default constructor
